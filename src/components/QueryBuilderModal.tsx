...
export const TAG_GROUPS: { name: string; tags: TagItem[] }[] = [
  {
    ...
    tags: [
      { prefix: 'ar:', label: 'artist/remixer:', description: 'Song artist or remixer' },
      { prefix: 'a:', label: 'artist:', description: 'Song artist' },
      { prefix: 'remixer:', label: 'remixer:', description: 'Song remixer' },
      { prefix: 't:', label: 'title:', description: 'Song title' },
      { prefix: 'n:', label: 'album:', description: 'Album name' },
      { prefix: 'l:', label: 'label:', description: 'Record label' },
      { prefix: 'c:', label: 'curator:', description: 'Discovery curator' },
  ...
  },
  {
    ...
    tags: [
      { prefix: 'r:=0', label: 'rating:=0', description: 'Unrated songs.' },
      { prefix: 'r:3', label: 'rating:3', description: 'Great songs.' },
      { prefix: 'r:4', label: 'rating:4', description: 'Epic songs.' },
      { prefix: 'bpm:', label: 'bpm:', description: 'Song BPM (single e.g. 128 or span 120-130)' },
      { prefix: 'e:', label: 'energy:', description: 'Song energy 0-10' },
      { prefix: 'y:', label: 'year:', description: 'Release year' },
      { prefix: 'month:', label: 'month:', description: 'Release month 1-12' },
      { prefix: 'day:', label: 'day:', description: 'Release day 1-31' },
      { prefix: 'l:', label: 'limit:', description: 'Result count limit' },
    ],
  },
  {
    name: 'Sorting & Status',
    tags: [
      { prefix: 'o:rand', label: 'order:rand', description: 'Random sort' },
      { prefix: 'o:released', label: 'order:released', description: 'Release date sort' },
      { prefix: 'o:added', label: 'order:added', description: 'Date added sort' },
      { prefix: 'o:bpm', label: 'order:bpm', description: 'BPM sort' },
      { prefix: 'o:album', label: 'order:album', description: 'Album sort' },
      { prefix: 'trashed:0', label: 'trashed:0', description: 'Non-deleted songs' },
      { prefix: 'el:0', label: 'explicit:0', description: 'Clean / non-explicit' },
      { prefix: 'm:1', label: 'mixed:1', description: 'Continuous DJ mixed' },
      { prefix: 'm:0', label: 'mixed:0', description: 'Unmixed album' },
    ],
  },
  {
