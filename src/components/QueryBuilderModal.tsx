...
export const TAG_GROUPS: { name: string; tags: TagItem[] }[] = [
  {
    ...
    tags: [
      { prefix: 'artist:', label: 'artist:', description: 'Song artist (a:)' },
      { prefix: 'title:', label: 'title:', description: 'Song title (t:)' },
      { prefix: 'album:', label: 'album:', description: 'Album name (n:)' },
      { prefix: 'remixer:', label: 'remixer:', description: 'Song remixer' },
      { prefix: 'label:', label: 'label:', description: 'Record label (l:)' },
      { prefix: 'curator:', label: 'curator:', description: 'Discovery curator (c:)' },
  ...
  },
  {
    ...
    tags: [
      ...
      { prefix: 'rating:', label: 'rating:', description: 'Minimum song rating 0-5 (r:)' },
      { prefix: 'energy:', label: 'energy:', description: 'Song energy 0-10 (e:)' },
      { prefix: 'year:', label: 'year:', description: 'Release year (y:)' },
      { prefix: 'month:', label: 'month:', description: 'Release month 1-12' },
      { prefix: 'day:', label: 'day:', description: 'Release day 1-31' },
      { prefix: 'limit:', label: 'limit:', description: 'Result count limit (l:)' },
    ],
  },
  {
    name: 'Sorting & Status',
    tags: [
      { prefix: 'order:rand', label: 'order:rand', description: 'Random sort' },
      { prefix: 'order:released', label: 'order:released', description: 'Release date sort' },
      { prefix: 'order:added', label: 'order:added', description: 'Date added sort' },
      { prefix: 'order:bpm', label: 'order:bpm', description: 'BPM sort' },
      { prefix: 'order:album', label: 'order:album', description: 'Album sort' },
      { prefix: 'trashed:1', label: 'trashed:1', description: 'Deleted songs' },
      { prefix: 'trashed:0', label: 'trashed:0', description: 'Non-deleted songs' },
      { prefix: 'mixed:1', label: 'mixed:1', description: 'Continuous DJ mixed' },
